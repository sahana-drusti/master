...
import 'package:drusti/VehicleHomePage.dart';
...
class VehicleLoginAndRegisteration extends StatelessWidget {
  final String type;
  VehicleLoginAndRegisteration({required this.type});

  @override
  Widget build(BuildContext context) {
    return VehicleLoginAndRegisterationPage();
  }
}

class VehicleLoginAndRegisterationPage extends StatefulWidget {
  @override
  VehicleLoginAndRegisterationPageState createState() =>
      VehicleLoginAndRegisterationPageState();
}

class VehicleLoginAndRegisterationPageState extends State {
  bool login = true;
  bool signup = false;
